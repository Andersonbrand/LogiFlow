...
// Larguras FIXAS e iguais para cabeçalho e linhas (checkbox | fornecedor/categoria | módulo | nº boleto | vencimento | valor | status)
const BOLETOS_COLS = 'grid-cols-[28px_minmax(0,1fr)_120px_140px_100px_110px_170px]';
                    ...
                    <div className="rounded-2xl border overflow-hidden overflow-x-auto" style={{ borderColor: 'var(--color-border)' }}>
                        <div className="min-w-[820px]">
                            <div className={`grid ${BOLETOS_COLS} gap-3 px-4 py-2.5 text-[11px] font-semibold uppercase tracking-wide`} style={{ backgroundColor: '#F9FAFB', color: 'var(--color-muted-foreground)' }}>
                                ...
                                <span className="truncate">Módulo</span>
                                ...
                                filtrados.map(b => {
                                    ...
                                    return (
                                        <div key={b.key} className={`grid ${BOLETOS_COLS} gap-3 px-4 py-3 items-center border-t text-sm`} style={{ borderColor: 'var(--color-border)' }}>
                                            ...
                                            <span className="text-xs font-medium px-2 py-1 rounded-md whitespace-nowrap truncate" style={{ color: ORIGEM_COR[b.origem], backgroundColor: `${ORIGEM_COR[b.origem]}1A` }}>
